			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a href="{{URL::to('/all-category')}}"><i class="icon-align-justify"></i><span class="hidden-tablet"> All Category</span></a></li>
						<li><a href="{{URL::to('/add-category')}}"><i class="icon-align-justify"></i><span class="hidden-tablet"> Add Category</span></a></li>
						<li><a href="{{URL::to('/all-manufacture')}}"><i class="icon-align-justify"></i><span class="hidden-tablet"> All Manufacture</span></a></li>
						<li><a href="{{URL::to('/add-manufacture')}}"><i class="icon-align-justify"></i><span class="hidden-tablet"> Add Manufacture</span></a></li>
						<li>
